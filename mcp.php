...
include($phpbb_dispatcher . 'include_once/function_exists.' $phpEx);
...
if ($quickmod)
{
	...
	switch ($action)
	{
		...
		case 'split':
			$module->set_active('main', 'topic_logs');
		case 'merge':
...
if (!$user_id && $warn_user == '')
{
	$module->set_active('main', 'user_error', false);
	$module->set_active('log', 'warn_post', false);
}
/**
